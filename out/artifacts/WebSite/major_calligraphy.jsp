...
<html>
<head>
    <title>中艺星源教育-书法艺考培训</title>
    <link href="major_calligraphy.css" type="text/css" rel="stylesheet">
...
<div id="profession_poster">
    <img src="images/theme_pic_calligraphy.jpg">
...
<div class="box_style1" id="advantage_box">
    <div class="introduce_box">
        <div class="theme_title">书法高考有哪些优势</div>
        <div class="theme_title_EN">— ADVANTAGE —</div>
        <div class="detail">学生通过书法艺考，专业通过联考、校考后，以相对较低的高考分数被中国传媒大学、浙江传媒学院等重点大学录取，毕业后就业前景广阔。</div>
    </div>
...
<div class="box_style2" id="college_define_box">
    <div class="introduce_box">
        <div class="theme_title">书法生可以报考哪些大学</div>
        <div class="theme_title_EN">— UNIVERSITY —</div>
        <div class="detail">全国书法主持专业院校超过一百三十所，除以中国传媒大学、浙江传媒学院为代表的专业艺术院校外，全国985、211及普通本科综合性院校均开设有书法类专业，学生可根据自己兴趣特长、院校特色专业进行针对性报考。</div>
    </div>
...
<div class="box_style1" id="college_define_box">
    <div class="introduce_box">
        ...
        <div class="detail">中艺星源艺术学校在23年办学过程中不断总结教学精髓，和各大知名出版社自研出版了数十套书法教学教案，内容涵盖历年考题、专业学习要点等，能帮助学生短时间内掌握学习方法，提高学习效率。</div>
    </div>
